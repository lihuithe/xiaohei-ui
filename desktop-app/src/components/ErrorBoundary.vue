<template>
  <div v-if="hasError" class="error-boundary p-4 bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800 rounded-lg">
    ...
    <details class="mt-4">
      ...
      <pre class="mt-2 p-2 bg-red-100 dark:bg-red-900 rounded text-xs overflow-x-auto">{{ error?.stack || error }}</pre>
    </details>
    <button
      @click="reset"
